...
class ReviewController extends Controller
{
	...
	public function getEmployee($data)
	{
		...
		$result = $provider->firstname . ' ' . $provider->middle . ' ' . $provider->lastname;
		return $result;
	}

	public function getReviewer($data)
	{
		$provider = Employee::model()->findByPK($data->reviewer);
		$result = $provider->firstname . ' ' . $provider->middle . ' ' . $provider->lastname;
		return $result;
	}
	...
	{
		if ($data->status=="0") return "Scheduled";
