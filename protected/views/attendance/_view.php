<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('punch_in')); ?>:</b>
	<?php echo CHtml::encode($data->punch_in); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('punch_out')); ?>:</b>
	<?php echo CHtml::encode($data->punch_out); ?>
	<br />
